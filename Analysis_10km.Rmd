...
test1 <- lm(log(avg_price) ~ log(coral_cover) + log(dist_to_reef) + log(rating) + log(near_dist_beach) + log(dist_to_access_points) + pool + gym + free_parking + conference + air_trans + position + beachfront + breakfast + log(class), data = data4)
summary(test1)
